...
export const MODULES: Module[] = [
  ...
  },
  {
    ...
    emoji: '📼',
    color: '#a3e635',
    tagline: 'Two arguments worth stealing: a harness where everything is a plugin, and a gauntlet that replaces steering with gates',
    days: 'Bonus · after Day 22',
    bonus: true,
    lessons: m10Lessons,
    boss: {
      title: 'Steal Both Ideas',
      description:
        'Take one idea from each lesson and land it in a repo you actually work in. From the harness lesson: prove you can see what your agent did, end to end, and replace one layer you were told was fixed. From the gauntlet lesson: retire a steering rule by turning it into a check that fails the build, then verify your tests assert rather than merely execute.',
      requirements: [
        ...
        'A one-page verdict naming which of the two philosophies fits your work, and the one thing you rejected from each',
      ],
      xp: 300,
      badgeId: 'boss-m10',
    },
